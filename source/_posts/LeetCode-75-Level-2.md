...
public:
    string multiply(string num1, string num2) {
      ...
      vector<int> ans(l1 + l2 , 0); // how much digital for this result;
...
```
im not work this problem out 
so i learing from this :
C++ Simple, Easy and Short Solution, Brief Explanation
233
YehudisK's avatar
YehudisK

12638
Last Edit: November 7, 2021 8:18 AM
